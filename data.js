...
const i18n = {
    ja: { 
        ...
        "counter-title": "総訪問者数",
        "bbs-desc": "情報交換や質問、フレンド募集などご自由に書き込んでください！（※不適切な発言は管理者が削除・ブロックします）"
    },
    en: { 
        "nav-home": "HOME", "nav-guide": "GUIDE", "nav-db": "DATABASE", "nav-pbuff": "P-BUFF", "nav-qa": "Q&A", "nav-about": "ABOUT ME", "nav-bbs": "BBS",
        ...
        "bbs-desc": "Feel free to exchange info, ask questions, or find friends here! (Inappropriate comments will be deleted/blocked.)"
    },
    ko: { 
        ...
        "bbs-desc": "정보 교환이나 질문 등을 자유롭게 남겨주세요! (부적절한 발언은 관리자가 삭제/차단합니다)"
    },
    zh: { 
        "nav-home": "首页", "nav-guide": "指南", "nav-db": "数据库", "nav-pbuff": "P-BUFF", "nav-qa": "常见问题", "nav-about": "关于我", "nav-bbs": "留言板",
        "about-title": "关于作者",
        "about-p1": "从2016年开始关注球场。2024年再次回归。", "about-p2": "希望能有更多玩家。让我们一起让这个社区火热起来！",
        ...
        "counter-title": "总访问人数",
        "bbs-desc": "欢迎在这里自由交流、提问或寻找好友！（不当言论将被管理员删除/封禁）"
    }
};
