...
const i18n = {
    ja: { 
        "nav-home": "HOME", "nav-guide": "GUIDE", "nav-db": "DATABASE", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-BUFF", "nav-qa": "Q&A", "nav-about": "ABOUT ME", "nav-survey": "SURVEY",
    ...
    ko: { 
        "nav-home": "홈", "nav-guide": "가이드", "nav-db": "데이터베이스", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-버프", "nav-qa": "Q&A", "nav-about": "소개", "nav-survey": "설문조사",
    ...
    zh: { 
        "nav-home": "首页", "nav-guide": "指南", "nav-db": "数据库", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-BUFF", "nav-qa": "常见问题", "nav-about": "关于我", "nav-survey": "问卷调查",
...
const charImages = { 
    ...
    "Luna": "https://common-cdn-api.joycityglobal.com/3on3/homepage/characters/skill/luna/chr_b.png"，"Basky": "basky.png",
};
...
// VIDEOS用のキャラクター紹介動画データもここに含めておくと完璧です
