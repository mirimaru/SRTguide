...
// 辞書100%完全網羅（全バフ効果を漏れなく翻訳）
const termsDict = {
    en: { 
        "ポスト": "POST", "ミドル": "MID", "3点": "3PT", "Sレイ": "S-LAY", "Lレイ": "L-LAY", "Sダン": "S-DUNK", "Lダン": "L-DUNK", "パス": "PASS", "スティ": "STL", "Jブロ": "J-BLK", "Dブロ": "D-BLK", "当たり": "STR", "リバ": "REB", "ラン": "RUN", "持久": "STM",
        "ノーマーク3点シュート成功率": "Open 3PT Success", "ドライブ時 'アンクル' 時間増加": "Ankle Break Duration", "ミドルシュートのブロック抵抗": "Mid Shot Blk Res", "3点シュートのブロック抵抗": "3PT Blk Res", "ロングレイアップ ブロック抵抗": "L-Layup Blk Res", "ロングレイアップ 守備抵抗": "L-Layup Def Res",
        "ゴール下シュート守備抵抗": "Post Shot Def Res", "ゴール下シュート成功率": "Post Shot Success", "スティールモーション速度": "Steal Motion Speed", "ダイビングキャッチ成功率": "Diving Catch Success", "クイックジャンパー 成功率": "Quick Jumper Success",
        "ブロック抵抗成功率": "Blk Resist Success", "ドライブモーション速度": "Drive Speed", "アンクルブレイク抵抗": "Ankle Break Res", "ロングダンク 成功率": "L-Dunk Success", "ポストショット 成功率": "Post Shot Success",
        "ロングレイアップ成功率": "L-Layup Success", "ロングレイアップ 成功率": "L-Layup Success", "ミドルシュート 成功率": "Mid Shot Success", "3点シュート守備抵抗": "3PT Def Res", "レイアップ/ダンク距離": "Layup/Dunk Dist",
        "Sレイアップ ブロック抵抗": "S-Layup Blk Res", "3点シュート距離增加": "3PT Distance", "3点シュート距離増加": "3PT Distance", "Sレイアップ 成功率": "S-Layup Success", "Lダンク ブロック抵抗": "L-Dunk Blk Res",
        "Sダンク ブロック抵抗": "S-Dunk Blk Res", "Dインシュート ブロック": "Drive-in Blk", "Jシュート ブロック": "Jump-shot Blk", "3点シュート 成功率": "3PT Success", "スティール成功率": "Steal Success",
        "Lダンク 発動確率": "L-Dunk Chance", "Sダンク 発動確率": "S-Dunk Chance", "Sダンク 守備抵抗": "S-Dunk Def Res", "Lダンク 守備抵抗": "L-Dunk Def Res", "Sレイ 守備抵抗": "S-Layup Def Res",
        "Lレイ ブロック抵抗": "L-Layup Blk Res", "Lレイ 守備抵抗": "L-Layup Def Res", "持久力の回復量": "Stamina Recovery", "一般の移動速度": "Move Speed", "シュート妨害効果": "Shot Interfere",
        "Oリバウンド能力": "O-Rebound", "Dリバウンド能力": "D-Rebound", "持久力の最大量": "Max Stamina", "ミドル守備抵抗": "Mid Def Res", "Sダンク 成功率": "S-Dunk Success", "Sダンクの速度": "S-Dunk Speed",
        "ミドルシュート": "Mid Shot", "ミドルショット": "Mid Shot", "ロングレイアップ": "Long Layup", "ロングダンク": "Long Dunk", "3点シュート": "3PT Shot", "最大持久力": "Max Stamina", "当たり強さ": "Strength",
        "パス速度": "Pass Speed", "スティール": "Steal", "ランニング": "Running", "リバウンド": "Rebound", "持久力": "Stamina", "パス": "Pass"
    },
    ko: { 
        "ポスト": "포스트", "ミドル": "미들", "3点": "3점", "Sレイ": "S레이업", "Lレイ": "L레이업", "Sダン": "S덩크", "Lダン": "L덩크", "パス": "패스", "スティ": "스틸", "Jブロ": "J블록", "Dブロ": "D블록", "当たり": "몸싸움", "リバ": "리바운드", "ラン": "달리기", "持久": "지구력",
        "ノーマーク3点シュート成功率": "노마크 3점슛 성공률", "ドライブ時 'アンクル' 時間増加": "돌파 시 앵클 시간 증가", "ミドルシュートのブロック抵抗": "미들슛 블록 저항", "3点シュートのブロック抵抗": "3점슛 블록 저항", "ロングレイアップ ブロック抵抗": "롱레이업 블록 저항", "ロングレイアップ 守備抵抗": "롱레이업 수비 저항",
        "ゴール下シュート守備抵抗": "골밑슛 수비 저항", "ゴール下シュート成功率": "골밑슛 성공률", "スティールモーション速度": "스틸 모션 속도", "ダイビングキャッチ成功率": "다이빙 캐치 성공률", "クイックジャンパー 成功率": "퀵 점퍼 성공률",
        "ブロック抵抗成功率": "블록 저항 성공률", "ドライブモーション速度": "돌파 모션 속도", "アンクルブレイク抵抗": "앵클 브레이크 저항", "ロングダンク 成功率": "L덩크 성공률", "ポストショット 成功率": "포스트 성공률",
        "ロングレイアップ成功率": "롱레이업 성공률", "ロングレイアップ 成功率": "롱레이업 성공률", "ミドルシュート 成功率": "미들슛 성공률", "3点シュート守備抵抗": "3점슛 수비 저항", "レイアップ/ダンク距離": "레이업/덩크 거리",
        "Sレイアップ ブロック抵抗": "S레이업 블록 저항", "3点シュート距離增加": "3점슛 거리 증가", "3点シュート距離増加": "3점슛 거리 증가", "Sレイアップ 成功率": "S레이업 성공률", "Lダンク ブロック抵抗": "L덩크 블록 저항",
        "Sダンク ブロック抵抗": "S덩크 블록 저항", "Dインシュート ブロック": "돌파 블록", "Jシュート ブロック": "점프슛 블록", "3点シュート 成功率": "3점슛 성공률", "スティール成功率": "스틸 성공률",
        "Lダンク 発動確率": "L덩크 발동 확률", "Sダンク 発動確率": "S덩크 발동 확률", "Sダンク 守備抵抗": "S덩크 수비 저항", "Lダンク 守備抵抗": "L덩크 수비 저항", "Sレイ 守備抵抗": "S레이업 수비 저항",
        "Lレイ ブロック抵抗": "L레이업 블록 저항", "Lレイ 守備抵抗": "L레이업 수비 저항", "持久力の回復量": "지구력 회복량", "一般の移動速度": "일반 이동 속도", "シュート妨害効果": "슛 방해",
        "Oリバウンド能力": "공격 리바운드", "Dリバウンド能力": "수비 리바운드", "持久力の最大量": "최대 지구력", "ミドル守備抵抗": "미들 수비 저항", "Sダンク 成功率": "S덩크 성공률", "Sダンクの速度": "S덩크 속도",
        "ミドルシュート": "미들슛", "ミドルショット": "미들슛", "ロングレイアップ": "롱레이업", "ロングダンク": "롱덩크", "3点シュート": "3점슛", "最大持久力": "최대 지구력", "当たり強さ": "몸싸움",
        "パス速度": "패스 속도", "スティール": "스틸", "ランニング": "달리기", "リバウンド": "리바운드", "持久力": "지구력", "パス": "패스"
    },
    zh: { 
        "ポスト": "近投", "ミドル": "中投", "3点": "三分", "Sレイ": "近距上篮", "Lレイ": "远距上篮", "Sダン": "近距扣篮", "Lダン": "远距扣篮", "パス": "传球", "スティ": "抢断", "Jブロ": "跳投盖帽", "Dブロ": "上篮盖帽", "当たり": "对抗", "リバ": "篮板", "ラン": "跑动", "持久": "耐力",
        "ノーマーク3点シュート成功率": "空位三分命中率", "ドライブ時 'アンクル' 時間増加": "突破晃倒时间增加", "ミドルシュートのブロック抵抗": "中投抗盖帽", "3点シュートのブロック抵抗": "三分抗盖帽", "ロングレイアップ ブロック抵抗": "远距上篮抗盖帽", "ロングレイアップ 守備抵抗": "远距上篮抗干扰",
        "ゴール下シュート守備抵抗": "篮下抗干扰", "ゴール下シュート成功率": "篮下投篮命中率", "スティールモーション速度": "抢断动作速度", "ダイビングキャッチ成功率": "扑球成功率", "クイックジャンパー 成功率": "快速跳投命中率",
        "ブロック抵抗成功率": "抗盖帽成功率", "ドライブモーション速度": "突破动作速度", "アンクルブレイク抵抗": "晃倒抵抗", "ロングダンク 成功率": "远距扣篮命中率", "ポストショット 成功率": "近投命中率",
        "ロングレイアップ成功率": "远距上篮命中率", "ロングレイアップ 成功率": "远距上篮命中率", "ミドルシュート 成功率": "中投命中率", "3点シュート守備抵抗": "三分抗干扰", "レイアップ/ダンク距離": "上篮/扣篮距离",
        "Sレイアップ ブロック抵抗": "近距上篮抗盖帽", "3点シュート距離增加": "三分球距离增加", "3点シュート距離増加": "三分球距离增加", "Sレイアップ 成功率": "近距上篮命中率", "Lダンク ブロック抵抗": "远距扣篮抗盖帽",
        "Sダンク ブロック抵抗": "近距扣篮抗盖帽", "Dインシュート ブロック": "突破盖帽", "Jシュート ブロック": "跳投盖帽", "3点シュート 成功率": "三分命中率", "スティール成功率": "抢断成功率",
        "Lダンク 発動確率": "远距扣篮触发率", "Sダンク 発動確率": "近距扣篮触发率", "Sダンク 守備抵抗": "近距扣篮抗干扰", "Lダンク 守備抵抗": "远距扣篮抗干扰", "Sレイ 守備抵抗": "近距上篮抗干扰",
        "Lレイ ブロック抵抗": "远距上篮抗盖帽", "Lレイ 守備抵抗": "远距上篮抗干扰", "持久力の回復量": "耐力恢复量", "一般の移動速度": "移动速度", "シュート妨害効果": "投篮干扰效果",
        "Oリバウンド能力": "进攻篮板", "Dリバウンド能力": "防守篮板", "持久力の最大量": "最大耐力", "ミドル守備抵抗": "中投抗干扰", "Sダンク 成功率": "近距扣篮命中率", "Sダンクの速度": "近距扣篮速度",
        "ミドルシュート": "中投", "ミドルショット": "中投", "ロングレイアップ": "远距上篮", "ロングダンク": "远距扣篮", "3点シュート": "三分球", "最大持久力": "最大耐力", "当たり強さ": "对抗",
        "パス速度": "传球速度", "スティール": "抢断", "ランニング": "跑动", "リバウンド": "篮板", "持久力": "耐力", "パス": "传球"
    }
};
...
// [ポスト, ミドル, 3点, Sレイ, Lレイ, Sダン, Lダン, パス, スティ, Jブロ, Dブロ, 当たり, リバ, ラン, 持久]
const rawData = [
    ...
    // ジェネーザの2モード（Flash: デフォルト / Dynamic: 3点・スティ・ラン-40, ミドル・Lダン・Jブロ+40）
