...
const i18n = {
    ja: { 
        "nav-home": "HOME", "nav-guide": "GUIDE", "nav-db": "DATABASE", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-BUFF", "nav-qa": "Q&A", "nav-about": "ABOUT ME", "nav-bbs": "BBS", "nav-survey": "SURVEY",
        ...
        "db-note": "※「▲」表記はバフ値（加算）です。 ／ ※バスキーは999pt振り分け可能（各項目最大25まで）", "qa-q1": "Q: 数値の「▲」は何？", "qa-a1": "A: バフ値（強化分）です。", "qa-q2": "Q: P-Buffとカードどちらが先？", "qa-a2": "A: P-Buffが先です。", "counter-title": "総訪問者数",
        ...
        "village-map-title": "ビレッジ プレゼント出現MAP", "village-map-cap": "※画像タップ（クリック）で拡大表示"
    },
    en: { 
        "nav-home": "HOME", "nav-guide": "GUIDE", "nav-db": "DATABASE", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-BUFF", "nav-qa": "Q&A", "nav-about": "ABOUT ME", "nav-bbs": "BBS", "nav-survey": "SURVEY",
        ...
        "db-note": "*'▲' indicates a buff. / *Basky can allocate 999 points (max 25 per stat).", "qa-q1": "Q: What does '▲' mean?", "qa-a1": "A: It's the buff value.", "qa-q2": "Q: P-Buff or Cards first?", "qa-a2": "A: P-Buff first.", "counter-title": "TOTAL VISITORS",
        ...
        "village-map-title": "VILLAGE PRESENT MAP", "village-map-cap": "*Tap/Click image to enlarge"
    },
    ko: { 
        "nav-home": "홈", "nav-guide": "가이드", "nav-db": "데이터베이스", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-버프", "nav-qa": "Q&A", "nav-about": "소개", "nav-bbs": "게시판", "nav-survey": "설문조사",
        ...
        "db-note": "*'▲' 표시는 버프 값입니다. / *배스키는 999포인트 배분 가능 (각 항목 최대 25)", "qa-q1": "Q: '▲'는 무엇입니까?", "qa-a1": "A: 버프 값입니다.", "qa-q2": "Q: P-버프와 카드 중 어느 것이 먼저입니까?", "qa-a2": "A: P-버프가 먼저입니다.", "counter-title": "총 방문자 수",
        ...
        "village-map-title": "빌리지 선물 등장 맵", "village-map-cap": "*이미지 클릭 시 확대"
    },
    zh: { 
        "nav-home": "首页", "nav-guide": "指南", "nav-db": "数据库", "nav-ping": "PING MAP", "nav-videos": "VIDEOS", "nav-pbuff": "P-BUFF", "nav-qa": "常见问题", "nav-about": "关于我", "nav-bbs": "留言板", "nav-survey": "问卷调查",
        ...
        "db-note": "*“▲”表示增益值。/ *巴斯基可分配999点（每项上限25）", "qa-q1": "Q: “▲”是什么意思？", "qa-a1": "A: 它是增益值。", "qa-q2": "Q: 先做P-Buff还是卡牌？", "qa-a2": "A: 先做P-Buff。", "counter-title": "总访问人数",
...
const rawData = [
    ...
    {"名前":"ジェネーザ(フラッシュ)","en":"Genesa (Flash)","pos":"PG","s":[153,153,178,102,178,127,164,165,231,140,127,114,114,224,191]},
    {"名前":"ジェネーザ(ダイナミック)","en":"Genesa (Dynamic)","pos":"PG","s":[153,193,138,102,178,127,204,165,191,180,127,114,114,184,191]},
    ...
    {"名前":"バスキー(PG)","en":"Basky(PG)","pos":"PG","s":[145, 145, 145, 145, 145, 145, 145, 175, 175, 145, 125, 125, 125, 175, 145]},
    ...
    {"名前":"フレッド","en":"Fred","pos":"SG","s":[140,191,204,140,191,89,102,178,191,127,102,76,89,178,153]},
    ...
    {"名前":"ラビエタ","en":"Lavieta","pos":"SG","s":[127,178,229,140,204,89,89,165,152,153,102,89,89,229,191]},
    {"名前":"バスキー(SG)","en":"Basky(SG)","pos":"SG","s":[125, 175, 175, 145, 145, 145, 145, 145, 145, 145, 145, 125, 125, 175, 145]},
    ...
    {"名前":"ルナ","en":"Luna","pos":"SF","s":[153,204,153,127,165,114,165,140,114,178,140,114,140,153,178]},
    {"名前":"バスキー(SF)","en":"Basky(SF)","pos":"SF","s":[135, 165, 145, 145, 165, 145, 145, 145, 135, 165, 145, 135, 145, 145, 145]},
    ...
    {"名前":"バスキー(PF)","en":"Basky(PF)","pos":"PF","s":[145, 145, 130, 145, 145, 145, 170, 145, 130, 170, 145, 145, 170, 130, 145]},
    ...
    {"名前":"バスキー(C)","en":"Basky(C)","pos":"C","s":[145, 145, 125, 145, 145, 145, 145, 145, 125, 145, 175, 175, 175, 125, 145]}
];
...
const pBuffData = {
    "C (CENTER)": [
        ...
        { name: "バスキー(C)", en: "Basky(C)", buffs: [["3点シュート", "+12"], ["ミドルシュート", "+12"], ["Dインシュート ブロック", "+12"], ["当たり強さ", "+12"], ["ロングダンク", "+12"]] }
    ],
    "PF (POWER FORWARD)": [
        ...
        { name: "ダブルD", en: "Double D", buffs: [["当たり強さ", "+12"], ["ロングダンク 成功率", "+3%"], ["3点シュート", "+12"], ["レイアップ/ダンク距離", "+20cm"], ["ロングダンク", "+12"]] },
        ...
        { name: "バスキー(PF)", en: "Basky(PF)", buffs: [["3点シュート", "+12"], ["ミドルシュート", "+12"], ["Dインシュート ブロック", "+12"], ["当たり強さ", "+12"], ["ロングダンク", "+12"]] }
    ],
    "SF (SMALL FORWARD)": [
        ...
        { name: "ルナ", en: "Luna", buffs: [["パス", "+14"], ["持久力", "+14"], ["ランニング", "+14"], ["ロングダンク", "+14"], ["3点シュート", "+14"]] },
        { name: "バスキー(SF)", en: "Basky(SF)", buffs: [["3点シュート", "+12"], ["ミドルシュート", "+12"], ["Dインシュート ブロック", "+12"], ["当たり強さ", "+12"], ["ロングダンク", "+12"]] }
    ],
    "PG (POINT GUARD)": [
        ...
        { name: "ジンジャー", en: "Ginger", buffs: [["パス速度", "+12cm/s"], ["ロングレイアップ 成功率", "+3%"], ["最大持久力", "+12"], ["スティール成功率", "+8.4%"], ["ミドルシュート 成功率", "+4%"]] },
        ...
        { name: "バスキー(PG)", en: "Basky(PG)", buffs: [["3点シュート", "+12"], ["ミドルシュート", "+12"], ["Dインシュート ブロック", "+12"], ["当たり強さ", "+12"], ["ロングダンク", "+12"]] }
    ],
    "SG (SHOOTING GUARD)": [
        ...
        { name: "リン", en: "Rin", buffs: [["ミドルシュート 成功率", "+7.5%"], ["一般の移動速度", "+14.4cm/s"], ["最大持久力", "+12"], ["ノーマーク3点シュート成功率", "+3.2%"], ["スティール成功率", "+8.4%"]] },
        { name: "ジェイソン", en: "Jason", buffs: [["3点シュート 成功率", "+6%"], ["ブロック抵抗成功率", "+4.2%"], ["3点シュート", "+14"], ["ミドル守備抵抗", "+1.44%"], ["ミドルシュート 成功率", "+4%"]] },
        { name: "ウォーカー", en: "Walker", buffs: [["3点シュート守備抵抗", "+1.56%"], ["ミドルシュートのブロック抵抗", "+6%"], ["持久力の回復量", "+7.2"], ["一般の移動速度", "+14.4cm/s"], ["ゴール下シュート守備抵抗", "+1.08%"]] },
        ...
        { name: "ラビエタ", en: "Lavieta", buffs: [["スティールの速度", "+8.4%"], ["持久力", "+14"], ["ランニング", "+14"], ["ロングレイアップ", "+12"], ["当たり強さ", "+14"]] },
        { name: "バスキー(SG)", en: "Basky(SG)", buffs: [["3点シュート", "+12"], ["ミドルシュート", "+12"], ["Dインシュート ブロック", "+12"], ["当たり強さ", "+12"], ["ロングダンク", "+12"]] }
    ]
};

const characterVideos = [
    { name: "Lulu (ルル)", pos: "C", id: "b-01v1HsFDY", desc: "自由なダンクやボックスアウト、クイックポストアップ解説" },
    { name: "Murdock (マードック)", pos: "PF", id: "XGzjCnhXK3M", desc: "ディフェンス特化・シャドウブロックとスリップスクリーンの解説" },
