...
// ★翻訳辞書（スクリプトが空白を削除して検索するため、キーから空白を全削除しています）
const termsDict = {
    en: {
        "ノーマーク3点シュート成功率": "Open 3PT Success",
        "ドライブ時'アンクル'時間増加": "Ankle Break Duration",
        "ミドルシュートのブロック抵抗": "Mid Shot Blk Res",
        "3点シュートのブロック抵抗": "3PT Blk Res",
        "ロングレイアップブロック抵抗": "L-Layup Blk Res",
        "ロングレイアップ守備抵抗": "L-Layup Def Res",
        "ゴール下シュート守備抵抗": "Post Shot Def Res",
        "ゴール下シュート成功率": "Post Shot Success",
        "スティールモーション速度": "Steal Motion Speed",
        "ダイビングキャッチ成功率": "Diving Catch Success",
        "クイックジャンパー成功率": "Quick Jumper Success",
        "ブロック抵抗成功率": "Blk Resist Success",
        "ドライブモーション速度": "Drive Speed",
        "アンクルブレイク抵抗": "Ankle Break Res",
        "ロングダンク成功率": "L-Dunk Success",
        "ポストショット成功率": "Post Shot Success",
        "ロングレイアップ成功率": "L-Layup Success",
        "ミドルシュート成功率": "Mid Shot Success",
        "3点シュート守備抵抗": "3PT Def Res",
        "レイアップ/ダンク距離": "Layup/Dunk Dist",
        "Sレイアップブロック抵抗": "S-Layup Blk Res",
        "3点シュート距離增加": "3PT Distance",
        "3点シュート距離増加": "3PT Distance",
        "Sレイアップ成功率": "S-Layup Success",
        "Lダンクブロック抵抗": "L-Dunk Blk Res",
        "Sダンクブロック抵抗": "S-Dunk Blk Res",
        "Dインシュートブロック": "Drive-in Blk",
        "Jシュートブロック": "Jump-shot Blk",
        "3点シュート成功率": "3PT Success",
        "スティール成功率": "Steal Success",
        "Lダンク発動確率": "L-Dunk Chance",
        "Sダンク発動確率": "S-Dunk Chance",
        "Sダンク守備抵抗": "S-Dunk Def Res",
        "Lダンク守備抵抗": "L-Dunk Def Res",
        "Sレイ守備抵抗": "S-Layup Def Res",
        "Lレイブロック抵抗": "L-Layup Blk Res",
        "Lレイ守備抵抗": "L-Layup Def Res",
        "持久力の回復量": "Stam Recovery",
        "一般の移動速度": "Move Speed",
        "シュート妨害効果": "Shot Interfere",
        "Oリバウンド能力": "O-Rebound",
        "Dリバウンド能力": "D-Rebound",
        "持久力の最大量": "Max Stamina",
        "ミドル守備抵抗": "Mid Def Res",
        "Sダンク成功率": "S-Dunk Success",
        "Sダンクの速度": "S-Dunk Speed",
        "ミドルシュート": "Mid Shot",
        "ミドルショット": "Mid Shot",
        "ロングレイアップ": "Long Layup",
        "ロングダンク": "Long Dunk",
    ...
    ko: { 
        "ノーマーク3点シュート成功率": "노마크 3점슛 성공률",
        "ドライブ時'アンクル'時間増加": "돌파 시 앵클 시간 증가",
        "ミドルシュートのブロック抵抗": "미들슛 블록 저항",
        "3点シュートのブロック抵抗": "3점슛 블록 저항",
        "ロングレイアップブロック抵抗": "롱레이업 블록 저항",
        "ロングレイアップ守備抵抗": "롱레이업 수비 저항",
        "ゴール下シュート守備抵抗": "골밑슛 수비 저항",
        "ゴール下シュート成功率": "골밑슛 성공률",
        "スティールモーション速度": "스틸 모션 속도",
        "ダイビングキャッチ成功率": "다이빙 캐치 성공률",
        "クイックジャンパー成功率": "퀵 점퍼 성공률",
        "ブロック抵抗成功率": "블록 저항 성공률",
        "ドライブモーション速度": "돌파 모션 속도",
        "アンクルブレイク抵抗": "앵클 브레이크 저항",
        "ロングダンク成功率": "L덩크 성공률",
        "ポストショット成功率": "포스트 성공률",
        "ロングレイアップ成功率": "롱레이업 성공률",
        "ミドルシュート成功率": "미들슛 성공률",
        "3点シュート守備抵抗": "3점슛 수비 저항",
        "レイアップ/ダンク距離": "레이업/덩크 거리",
        "Sレイアップブロック抵抗": "S레이업 블록 저항",
        "3点シュート距離增加": "3점슛 거리 증가",
        "3点シュート距離増加": "3점슛 거리 증가",
        "Sレイアップ成功率": "S레이업 성공률",
        "Lダンクブロック抵抗": "L덩크 블록 저항",
        "Sダンクブロック抵抗": "S덩크 블록 저항",
        "Dインシュートブロック": "돌파 블록",
        "Jシュートブロック": "점프슛 블록",
        "3点シュート成功率": "3점슛 성공률",
        "スティール成功率": "스틸 성공률",
    ...
    zh: { 
        "ノーマーク3点シュート成功率": "空位三分命中率",
        "ドライブ時'アンクル'時間増加": "突破晃倒时间增加",
        "ミドルシュートのブロック抵抗": "中投抗盖帽",
        "3点シュートのブロック抵抗": "三分抗盖帽",
        "ロングレイアップブロック抵抗": "远距上篮抗盖帽",
        "ロングレイアップ守備抵抗": "远距上篮抗干扰",
        "ゴール下シュート守備抵抗": "篮下抗干扰",
        "ゴール下シュート成功率": "篮下投篮命中率",
        "スティールモーション速度": "抢断动作速度",
        "ダイビングキャッチ成功率": "扑球成功率",
        "クイックジャンパー成功率": "快速跳投命中率",
        "ブロック抵抗成功率": "抗盖帽成功率",
        "ドライブモーション速度": "突破动作速度",
        "アンクルブレイク抵抗": "晃倒抵抗",
        "ロングダンク成功率": "远距扣篮命中率",
