// ==========================================
// ★ キャラクター紹介動画のID管理リスト ★
// 動画が完成したら、ここにキャラ名とYouTubeのID（v= の後ろの文字列）を追加してください。
// 日本語名でも英語名でも反応するように強化しました！
// ==========================================
const charVideoIds = {
    "Giant G": "", // ジャイアントG（現在制作中）
    "牛魔王": "C8Shm4jd028",
...
function autoFixKoreanData() {
    const krFix = {
        ...
        "나디아": "나디아", "잭": "ジャック", "디콘": "ディーコン", "노아": "ノ아", "클로이": "クロエ",
