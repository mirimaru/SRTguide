...
// ==========================================
// ★ システム強化：新キャラクター＆公式URL自動インジェクション ★
...
window.termsDict = {
    ...
    'ko': {
        ...
        'ドライブイン': '드라이브 인', '페이스アップ': '페이스업', 'アリウープ': '앨리웁',
...
function autoFixKoreanData() {
    const krFix = {
        "리": "リー", "윌리엄": "ウィリアム", "머독": "マードック", "조い": "ジョイ", "신디": "シンディ",
        "헬레나": "ヘレナ", "페드로": "ペドロ", "크리스타": "クリスタ", "프로페서": "プロフェッサー",
        "아만다": "アマンダ", "킴": "キム", "카롤리나": "カロリーナ", "린": "リン", "카터": "カーター",
        "제이슨": "ジェイソン", "맥ス": "マックス", "클라크": "クラーク", "룰루": "ルル", "빅독": "ビッグドッグ",
        ...
        "리바운드": "リバウンド", "달리기": "ランニング", "지구력": "持久力", "스틸": "スティール", "패ス": "パス", "블록": "ブロック",
        "3점슛": "3点シュート", "3점": "3点", "미들슛": "ミドルシュート", "미들": "ミドル",
        "S덩크": "Sダンク", "L덩크": "Lダンク", "S레이アップ": "Sレイアップ", "Lレイアップ": "Lレイアップ",
...
// ページ起動時の全初期化処理
window.onload = () => { 
    injectNewCharacters(); // 新キャラ2人のステータス＆イラストリンクを自動挿入
